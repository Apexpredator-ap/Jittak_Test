...
import 'inputstacklist_item_model.dart';
...
class EditStoreProfileInformationModel {
  Rx<List<InputstacklistItemModel>> inputstacklistItemList = Rx([
    InputstacklistItemModel(
        userImage: ImageConstant.img20211122.obs,
        closeImage: ImageConstant.imgClose.obs),
    InputstacklistItemModel(userImage: ImageConstant.imgOutlineImage1.obs)
  ]);
  ...
  Rx<List<ViewhierarchyItemModel>> viewhierarchyItemList = Rx([
    ViewhierarchyItemModel(
        dynamicTextProp1: "火".obs, dynamicTextProp2: "土".obs),
    ViewhierarchyItemModel(
        dynamicTextProp1: "水".obs, dynamicTextProp2: "日".obs),
    ViewhierarchyItemModel(dynamicTextProp1: "木".obs, dynamicTextProp2: "祝".obs)
  ]);
