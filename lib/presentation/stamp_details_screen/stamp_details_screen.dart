import '../stamp_details_screen/widgets/fortyseven_item_widget.dart';
import '../stamp_details_screen/widgets/userprofile_item_widget.dart';
...
import 'package:test/widgets/app_bar/appbar_leading_iconbutton.dart';
import 'package:test/widgets/app_bar/appbar_subtitle.dart';
import 'package:test/widgets/app_bar/appbar_trailing_iconbutton.dart';
...
class StampDetailsScreen extends GetWidget<StampDetailsController> {
  ...
  PreferredSizeWidget _buildAppBar() {
    return CustomAppBar(
        ...
        centerTitle: true,
        title: AppbarSubtitle(text: "lbl10".tr),
        actions: [
    ...
    return Padding(
        ...
        child: Obx(() => CarouselSlider.builder(
            ...
            itemCount: controller
                .stampDetailsModelObj.value.fortysevenItemList.value.length,
            itemBuilder: (context, index, realIndex) {
              FortysevenItemModel model = controller
                  .stampDetailsModelObj.value.fortysevenItemList.value[index];
        ...
        child: Padding(
            ...
            child: Obx(() => ListView.separated(
                ...
                itemBuilder: (context, index) {
                  UserprofileItemModel model = controller.stampDetailsModelObj
